...
| **CLP(B) Constraints**| `:- use_module(`[`library(clpb)`](https://github.com/mthom/scryer-prolog/blob/master/src/lib/clpb.pl)`).` | `sat/1`, `taut/2`, `sat_count/2`, `weighted_maximum/3` | Boolean constraints via BDDs (circuits, tautologies, solution counting). |
